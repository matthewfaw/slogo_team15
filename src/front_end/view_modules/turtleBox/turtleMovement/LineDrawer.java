...
class LineDrawer implements IDrawer {
    ...
    LineDrawer (IViewableRobot aRobot,
                MovementCalculator aMoveCalc,
                IColorModule aColorMap,
                GraphicsContext aGC) {
        myRobot = aRobot;
        myMoveCalc = aMoveCalc;
        myColorMap = aColorMap;
        myGC = aGC;
        myInfo = myRobot.getPenInformation();
    }
    ...
    void drawDefault () {
        myGC.setStroke(myColorMap.getColor(myInfo.getColorID()));
