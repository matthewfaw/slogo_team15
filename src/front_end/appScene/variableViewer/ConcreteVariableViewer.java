...
class ConcreteVariableViewer implements IVariableViewer {
    ...
    ConcreteVariableViewer(int width, int height) {
        ...
        myNameColumn.setCellValueFactory( new Callback<TableColumn.CellDataFeatures<Variable,String>,ObservableValue<String>>(){
        ...
        myValueColumn.setCellValueFactory( new Callback<TableColumn.CellDataFeatures<Variable,String>,ObservableValue<String>>(){
